exports.arr = [
    ...
    },
    {
        ...
        desc: "Need for Speed: Most Wanted was developed by EA Black Box, released in 2005, and was one of the first games released for the Xbox 360. The PlayStation Portable port of Most Wanted is titled Need for Speed: Most Wanted 5-1-0"
    },
    {
        name: "Need for Speed: Carbon (2006)",
        img: "https://upload.wikimedia.org/wikipedia/en/a/a4/Need_for_Speed_Carbon_Game_Cover.jpg",
        desc: "Need for Speed: Carbon was developed by EA Black Box in 2006. It was the first NFS game for the PlayStation 3 and the Wii and the last NFS game for the GameCube, the Game Boy Advance, and the Xbox. Carbon's handheld port is known as Need for Speed: Carbon – Own the City. The Wii port lacked online but made full use of the Wii Remote and Nunchuk."
    },
    {
        name: "Tekken 3",
        img: "https://upload.wikimedia.org/wikipedia/en/7/7d/Tekken_3_flyer.jpg",
        desc: "Tekken 3 (鉄拳3) is a fighting game, the third entry in the Tekken series. It was released to the arcades in 1997, before being ported to the PlayStation in 1998. The arcade version of the game was released in 2005 for the PlayStation 2 as part of Tekken 5's Arcade History mode. The game was also re-released as part of Sony's PlayStation Classic."
    },
    {
        name: "Tekken 5",
        img: "https://upload.wikimedia.org/wikipedia/en/thumb/a/ad/Tekken5Cover.jpg/220px-Tekken5Cover.jpg",
        desc: "Tekken 5 (鉄拳5) is a fighting game developed and published by Namco for the arcades in 2004, and for the PlayStation 2 in 2005. It is the fifth main and sixth installment, in the Tekken series, marking the tenth anniversary of the series. The game is set shortly after the events of Tekken 4 featuring a new Antagonist named Jinpachi Mishima taking over the Mishima Zaibatsu while a sidestory focuses on the protagonist Jin Kazama as he faces several enemies from the G Corporation. The home version also contains a collector's edition of sorts, as it includes the arcade versions of Tekken, Tekken 2, Tekken 3, and StarBlade."
    },
    {
        name: "Tekken Tag Tournament 2",
        img: "https://upload.wikimedia.org/wikipedia/en/thumb/5/5c/Tekken_TT2_console.png/220px-Tekken_TT2_console.png",
        desc: "Tekken Tag Tournament 2 is the eighth installment in the Tekken fighting game series and the sequel to Tekken Tag Tournament. It was released for the arcades in September 2011. It received an update, subtitled Unlimited, in March 2012. A console version based on the update was released for PlayStation 3 and Xbox 360 in September 2012, prior to the update. It was ported to the Wii U as one of the system's launch titles in November 2012, subtitled Wii U Edition."
    },
    {
        name: "Grand Theft Auto: Vice City",
        img: "https://upload.wikimedia.org/wikipedia/en/c/ce/Vice-city-cover.jpg",
        desc: "Grand Theft Auto: Vice City is a 2002 action-adventure game developed by Rockstar North and published by Rockstar Games. It is the fourth main game in the Grand Theft Auto series, following 2001's Grand Theft Auto III, and the sixth entry overall. Set in 1986 within the fictional Vice City (based on Miami and Miami Beach), the single-player story follows mobster Tommy Vercetti's rise to power after being released from prison and becoming caught up in an ambushed drug deal. While seeking out those responsible, Tommy gradually builds a criminal empire by seizing power from other criminal organisations in the city."
    },
    {
        name: "Grand Theft Auto: San Andreas",
        img: "https://upload.wikimedia.org/wikipedia/en/thumb/c/c4/GTASABOX.jpg/220px-GTASABOX.jpg",
    ...
    },
    {
        ...
        img: "https://upload.wikimedia.org/wikipedia/en/9/90/Sleeping_Dogs_-_Square_Enix_video_game_cover.jpg",
        desc: "Sleeping Dogs is a 2012 action-adventure game developed by United Front Games and published by Square Enix. It was released for PlayStation 3, Windows, and Xbox 360 in August 2012.Set in contemporary Hong Kong, the story follows Wei Shen—a martial artist and undercover police officer as he infiltrates the Sun On Yee Triad organization.Gameplay emphasizes Shens martial arts combat, shooting, parkour abilities, and the use of various gadgets for both combat and exploration. Players complete missions to progress the storyline and unlock content, though they can also freely explore the open-world environment.While exploring, players can engage in both legal and illegal activities, with unlawful actions triggering police responses, regulated by a heat system. Performing actions such as fighting, driving, and racing grants Shen statistical upgrades and earns player achievements."
    },
    {
        name: "LA Noire: Combat Evolved",
        img: "https://upload.wikimedia.org/wikipedia/en/3/3c/LA-Noire-Box-Art.jpg",
    ...
    {
        name: "Max Payne 2",
        img: "https://upload.wikimedia.org/wikipedia/en/thumb/2/21/Max_Payne_2.jpg/220px-Max_Payne_2.jpg",
